export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx20b7d0ae4b567d40",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "220518b9c3ba50531207b09361bdd7dc",
  ...
  USERS: [
    {
      ...
      customizedDateList: [
        ...
        // 纪念日
        {"keyword": "marry_day", date: "2022-03-09"}
      ]
    }
  ],
  ...
  CALLBACK_TEMPLATE_ID: "T0VliBn4VLjJIFwVjKyk6TYeN2GBDgl_lWa1q-pefa8",
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "宝宝", "year": "2001", "date": "09-05", isShowAge: true},
    {"type": "节日", "name": "纪念日", "year": "2022", "date": "03-09"}
  ],
